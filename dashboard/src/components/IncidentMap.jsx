...
function IncidentMap({ incidents, blockedRoads = [], selectedIncident, onSelectIncident }) {
  ...
  return (
    <div className="h-full w-full relative">
      ...
      <div className="absolute bottom-4 left-4 z-[1000] bg-white rounded-lg p-4 shadow-lg border border-gray-200 hidden sm:block">
        {/* Incident Types Section */}
        <p className="text-sm text-gray-800 mb-3 font-semibold">Incident Types</p>
        <div className="space-y-2.5 mb-4">
          ...
          <div className="flex items-center gap-2.5">
            <div className="w-5 h-5 flex items-center justify-center text-lg">🚧</div>
            <span className="text-sm text-gray-700">Road Block</span>
          </div>
          <div className="flex items-center gap-2.5">
            <div className="w-5 h-5 flex items-center justify-center text-lg">⚡</div>
            <span className="text-sm text-gray-700">Power Line</span>
          </div>
        </div>
