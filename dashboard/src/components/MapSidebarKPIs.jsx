...
function MapSidebarKPIs({ incidents }) {
  ...
  // Type analysis (only Flood and Landslide)
  ...
  return (
    <div className="w-72 bg-gray-50 border-r border-gray-200 flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col p-2 gap-2 overflow-hidden">
        ...
        {/* Type Breakdown - Compact grid (only Flood and Landslide) */}
        <div className="flex flex-col gap-1 mt-auto">
          ...
          <div className="grid grid-cols-2 gap-1">
            <div className="bg-white border border-gray-200 rounded p-1.5 text-center">
              ...
              <div className="text-sm font-bold text-gray-900">{landslides}</div>
              <div className="text-[9px] text-gray-600">Landslides</div>
            </div>
            <div className="bg-white border border-gray-200 rounded p-1.5 text-center">
              <div className="text-lg">🌊</div>
              <div className="text-sm font-bold text-gray-900">{floods}</div>
              <div className="text-[9px] text-gray-600">Floods</div>
            </div>
          </div>
        </div>
      </div>
